...
FactoryBot.define do
  factory :health_event do
    ...
    name { 'health_event Name' }
    health_event_type { 0 } # Enum value for 'Quality Measures'
    health_event_category { rand(0..2) } # Enum value for 'Well Child Care'
    ...
    description { 'Sample health_event description.' }
    ...
    trait :with_icon do
      after(:build) do |health_event|
        health_event.icon.attach(
    ...
    #   after(:create) do |health_event|
    #     create_list(:action_step, 3, actionable: health_event)  # Assumes you have an ActionStep factory
    #   end
    # end

    # trait :with_member_selections do
    #   after(:create) do |health_event|
    #     create_list(:member_selection, 3, selectable: health_event)  # Assumes you have a MemberSelection factory
    #   end
    # end
  end
end
