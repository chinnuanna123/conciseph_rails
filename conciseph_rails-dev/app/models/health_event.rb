...
class HealthEvent < ApplicationRecord
  ...
  validates :name, :health_event_type, :health_event_category, :status, :start_date, :end_date, :section, presence: true
  ...
  def self.search(params)
    ...
    query = query.where(health_event_category: category) if category.present?
