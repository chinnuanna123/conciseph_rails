...
class HealthEducation < ApplicationRecord
  ...
  validates :name, :health_education_type, :health_education_category, :status, :start_date, :end_date, :section,
            presence: true
  ...
  enum health_education_category: {
    'Nutrition': 0,
  ...
  def self.search(params)
    ...
    query = query.where(health_education_category: category) if category.present?
