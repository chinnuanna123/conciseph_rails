...
class Announcement < ApplicationRecord
  ...
  validates :name, :announcement_type, :announcement_category, :status, :start_date, :end_date, :section, presence: true
  ...
  enum section: {
    'General': 0,
    'Eligibility & Benefits': 1,
    'Service/Care Providers': 2
  }
  ...
  def self.search(params)
    ...
    query = query.where(announcement_category: category) if category.present?
